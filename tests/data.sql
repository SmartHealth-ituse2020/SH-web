...
INSERT INTO doctor(name, surname, password, username, hospital, title, profession, added_by, national_id, isActive)
    VALUES
    ('dtest','surname1','password1','dtestuser','hospital1','title1','profession1',1,'dtestNid,', True),
    ('doctor1','surname1','password1','doctoruser1','hospital1','title1','profession1',1,'National_id1', True),
    ('deletedoctor1','surname1','password1','docdelete','hospital1','title1','profession1',1,'delete_Nid', True);
